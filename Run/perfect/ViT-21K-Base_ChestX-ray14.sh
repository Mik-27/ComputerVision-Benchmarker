...
#SBATCH --output=/scratch/mthaku12/ComputerVision-Benchmarker/slurm_op/ViT-21K-Base_ChestX-ray14-%j.out
#SBATCH --error=/scratch/mthaku12/ComputerVision-Benchmarker/slurm_op/ViT-21K-Base_ChestX-ray14-%j.err
#SBATCH --mem=80G
