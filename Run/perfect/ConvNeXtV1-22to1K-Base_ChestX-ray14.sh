...
#SBATCH --output=/scratch/hmudigon/Acad/CSE598-ODL/Supervised/slurm_op/ConvNeXtV1-22to1K-Base_ChestX-ray14-%j.out
#SBATCH --error=/scratch/hmudigon/Acad/CSE598-ODL/Supervised/slurm_op/ConvNeXtV1-22to1K-Base_ChestX-ray14-%j.err
#SBATCH --mem=80G
