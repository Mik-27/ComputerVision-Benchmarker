...
#SBATCH -q public
#SBATCH --job-name=SwinV1-21to1K-Base_ChestX-ray14.sh
#SBATCH --output=/scratch/hmudigon/Acad/CSE598-ODL/Supervised/slurm_op/SwinV1-21to1K-Base_ChestX-ray14-%j.out
#SBATCH --error=/scratch/hmudigon/Acad/CSE598-ODL/Supervised/slurm_op/SwinV1-21to1K-Base_ChestX-ray14-%j.err
#SBATCH --mem=80G
...
python main_classification.py \
	...
	--batch_size 512 \
	--epochs 200 \
	--exp_name SwinV1-21to1K-Base_ChestX-ray14 \
	--lr 0.01 \
	--opt sgd \
	--trial 10 \
	--warmup-epochs 0 \
