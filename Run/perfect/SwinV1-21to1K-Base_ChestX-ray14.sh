...
#SBATCH --output=/scratch/mthaku12/ComputerVision-Benchmarker/slurm_op/SwinV1-21to1K-Base_ChestX-ray14-%j.out
#SBATCH --error=/scratch/mthaku12/ComputerVision-Benchmarker/slurm_op/SwinV1-21to1K-Base_ChestX-ray14-%j.err
#SBATCH --mem=80G
