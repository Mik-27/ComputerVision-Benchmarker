...
#SBATCH -q public
#SBATCH --job-name=SwinV1BaseChestX-ray14
#SBATCH --output=/scratch/hmudigon/SOTA/Benchmarking-CV/slurm_op/SwinV1BaseChestX-ray14-%j.out
#SBATCH --error=/scratch/hmudigon/SOTA/Benchmarking-CV/slurm_op/SwinV1BaseChestX-ray14-%j.err
#SBATCH --mem=80G
...
cd /scratch/hmudigon/SOTA/Benchmarking-CV
echo_time "[+] Done"
echo ""
...
python main_classification.py \
	...
	--batch_size 64 \
	--epochs 200 \
	--exp_name SwinV1BaseChestX-ray14 \
	--lr 0.01 \
	--opt sgd \
	--trial 2 \
	--warmup-epochs 0 \
